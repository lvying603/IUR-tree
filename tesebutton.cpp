// tesebutton.cpp : implementation file
//
...
BEGIN_MESSAGE_MAP(Ctesebutton, CButton)
	//{{AFX_MSG_MAP(Ctesebutton)
...
/////////////////////////////////////////////////////////////////////////////
// Ctesebutton message handlers

//添加Owner Draw属性
void Ctesebutton::PreSubclassWindow() 
{
...
void Ctesebutton::OnMouseMove(UINT nFlags, CPoint point) 
{
...
LRESULT Ctesebutton::OnMouseLeave(WPARAM wParam, LPARAM lParam)
{
	m_bOver = FALSE;
	m_bTracking = FALSE;
...
LRESULT Ctesebutton::OnMouseHover(WPARAM wParam, LPARAM lParam)
{
	m_bOver = TRUE;
	InvalidateRect(NULL);
	return 0;
...
void Ctesebutton::DrawItem(LPDRAWITEMSTRUCT lpDrawItemStruct)
{
...
//绘制按钮的底色
void Ctesebutton::DoGradientFill(CDC *pDC, CRect* rect)
{
	int i;
	CBrush brBk[64];
...
//绘制按钮的内边框
void Ctesebutton::DrawInsideBorder(CDC *pDC, CRect* rect)
{
